...
public class AddressBookController {
    ...
    public ResponseEntity<List<AddressBook>> getFriendsList(@RequestParam(value = "unique", defaultValue = "true") final Boolean unique) throws InternalServerException {
        try {
            log.info("findFriendsList method invoked");
            List<AddressBook> friendsList = addressBookService.getFriendsList(unique);
