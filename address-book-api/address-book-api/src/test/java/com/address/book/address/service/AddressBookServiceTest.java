package com.address.book.address.service;

import com.address.book.address.model.AddressBook;
...
public class AddressBookServiceTest {
    ...
    public void testAllUniqueAddressBooks() {
        ...
        List<AddressBook> retrievedAddressBooksBeforeAddingDuplicates = addressBookService.findAddressBookList(true);
        ...
        List<AddressBook> retrievedAddressBookAfterAddingDuplicates = addressBookService.findAddressBookList(true);
    ...
    public void testAllAddressBooks() {
        ...
        List<AddressBook> retrievedAddressBooksBeforeAddingDuplicates = addressBookService.findAddressBookList(false);
        ...
        //At this point we added 4 Address but the below returned list should contain addition of 2 new records
        List<AddressBook> retrievedAddressBooksAfterAddingDuplicates = addressBookService.findAddressBookList(false);
